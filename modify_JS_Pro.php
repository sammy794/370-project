...
<body>
        ...
        <div class="content">
		    ...
		    <table border="1px">
			  ...
			  echo "<a onClick=\" javascript:return confirm('Are you sure you want to delete this candidate?');\"class='btn btn-danger' href='delete.php?job_seeker_id={$info['id']}'>Delete</a>"; 
			  ?>
				</td>
